...
const CompanyApplicationJobRow = ({ job }) => {
  ...
  return (
    <article className="grid min-w-0 gap-5 px-4 py-5 sm:px-5 xl:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.65fr)_auto] xl:items-center">
      {" "}
      ...
      >
        ...
        <div className="flex min-w-0 items-center justify-between gap-3 px-3 py-2.5 sm:block">
          ...
          <p className="min-w-0 wrap-break-word text-right text-xs font-medium leading-5 text-slate-700 sm:mt-1 sm:text-left">
        ...
        <div className="flex min-w-0 items-center justify-between gap-3 bg-violet-50/30 px-3 py-2.5 sm:block">
